...
export default function DayPlanner({ date, mealType, onDateChange, onMealTypeChange }: Props) {
  ...
  function addIngredient(ingredientId: number) {
    ...
    setDraft([
      ...draft,
      { ingredientId, quantity: Math.min(40, availableQty.get(ingredientId) ?? 0), unit: ing.unit, reasons: ['직접 추가'] },
    ])
  }
